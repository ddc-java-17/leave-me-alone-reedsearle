...
public interface UserDao {
  ...
  String QUERY_USER_ID = "SELECT * FROM user WHERE user_id = :id";
  String QUERY_OAUTH_KEY = "SELECT * FROM user WHERE oauth_key = :oauthKey";
  String QUERY_DISPLAY_NAME = "SELECT * FROM user ORDER BY display_name ASC";
